...
## Summary
- 3511 nodes · 6742 edges · 237 communities (153 shown, 84 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 753 edges (avg confidence: 0.89)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d541ba9c`
...
- get
- post
- test_resolve_staged_item_and_generate_embeddings
- intake_pasted_text
- patch
- post
- emailRenderer.js
...
10. `IntakeEvaluationTaskModel` - 30 edges
...
## Communities (237 total, 84 thin omitted)
...
Cohesion: 0.09
Nodes (53): AnalyzePipelineMetricsInput, ApplicationDetailsInput, DetectStalledApplicationsInput, EvaluateAIFitScoreInput, FetchWebpageContentInput, GetCandidateProfileInput, ListApplicationsInput, ManageActionItemsInput (+45 more)
...
### Community 8 - "JobPostingModel"
Cohesion: 0.09
Nodes (26): ApplicationEmbeddingModel, JobPostingModel, CandidateCVModel, clip_job_pre_extracted(), clip_job_url(), _extract_text_from_html(), AsyncSession, post (+18 more)
...
Cohesion: 0.11
Nodes (35): clean_company_name(), clean_domain(), extract_domain_from_url(), extract_organization_from_ats_url(), is_ats_hostname(), AsyncSession, query_clearbit_autocomplete(), Domain resolution service for extracting and discovering official company… (+27 more)
...
Cohesion: 0.13
Nodes (23): clear_prompt_cache(), AsyncSession, Invalidates the in-memory prompt cache for a specific prompt or all prompts., Seeds missing prompts into DB upon boot without overwriting existing user…, seed_default_prompts(), PromptModel, get_prompt(), list_prompts() (+15 more)
...
### Community 17 - "patch"
Cohesion: 0.16
Nodes (20): CVAnonymizationResult, DomainExperienceItem, calibrate_assessment_score_and_recommendation(), Applies mathematical bounding and recommendation synchronization to eliminate…, compute_programmatic_skill_match(), _is_skill_matched(), _normalize_token(), Checks if a JD required skill matches any skill in the candidate's CV profile. (+12 more)
...
Cohesion: 0.05
Nodes (47): activeTab, alignmentData, alignmentSubTab, analyticsData, analyticsStore, copiedItemKey, currentAlignmentKey, currentDossier (+39 more)
...
Cohesion: 0.06
Nodes (62): AssessJobRequest, assess_job_lead(), bulk_delete_evaluation_tasks(), bulk_retry_evaluation_tasks(), cancel_evaluation_task(), clear_completed_evaluations(), confirm_job_assessment(), delete_evaluation_task() (+54 more)
...
Cohesion: 0.12
Nodes (27): StagingItemModel, bulk_dismiss_staging_items(), clear_resolved_staging_items(), get_staging_item(), list_staging_items(), AsyncSession, delete, get (+19 more)
...
### Community 54 - "get_active_llm_config_dict"
Cohesion: 0.22
Nodes (15): get_active_llm_config_dict(), Strips <think>...</think> reasoning tags from LLM output text., Retrieves runtime LLM configuration from the database., strip_reasoning_tags(), extract_email_info(), Extracts structured job application metadata from email body using LangChain…, asyncio, AsyncSession (+7 more)
...
Cohesion: 0.15
Nodes (19): enhance_role_alignment_endpoint(), get_funnel_metrics(), get_overview(), get_role_alignment_dossier_endpoint(), get_role_alignment_endpoint(), AsyncSession, get, Enqueues an asynchronous AI Strategic Dossier synthesis task through the shared… (+11 more)
...
### Community 67 - "research_company_context"
Cohesion: 0.16
Nodes (18): build_company_research_query(), build_employer_signals_query(), _collect_company_evidence(), _fetch_selected_pages(), AsyncSession, Finds employee-reported signals for private interview preparation only., Reads the configured COMPANY_RESEARCH/Global provider concurrency ceiling., Fetches only triaged URLs through the existing Camofox-safe scraper. (+10 more)
...
Cohesion: 0.11
Nodes (36): AIHealthStatusRead, AIProviderCreate, AIProviderModel, AIProviderModelsResponse, AIProviderRead, AIProviderTestResponse, AIProviderUpdate, clear_embeddings_cache() (+28 more)

### Community 70 - "_execute_evaluation_steps"
Cohesion: 0.11
Nodes (38): get_setting(), Retrieves a specific system setting by key asynchronously., get_prompt_template(), Retrieves prompt template from DB with in-memory caching, falling back to…, _execute_application_qa_steps(), _execute_company_research_steps(), _execute_cover_letter_steps(), _execute_cv_extraction_steps() (+30 more)
...
Cohesion: 0.13
Nodes (26): asyncio, ApplicationModel, ApplicationAnalyzeSpecRequest, test_get_analytics_overview_unit(), test_get_funnel_performance_metrics_unit(), test_get_role_alignment_unit(), test_pipeline_funnel_active_and_dropped_unit(), test_analyze_spec_endpoint_validation_and_enqueue() (+18 more)
...
Cohesion: 0.13
Nodes (22): AITaskTestResponse, _clean_base_url(), FailoverChatModel, _get_cached_embeddings_model(), get_chat_model(), get_embeddings_model(), get_task_chat_model(), get_task_embeddings_model() (+14 more)

### Community 97 - "services/analytics.py"
Cohesion: 0.16
Nodes (23): AnalyticsOverviewResponse, BulletReframeItem, ExecutiveTrackFit, FunnelChartStage, FunnelCohortPeriod, FunnelKpiCard, FunnelStageItem, InterviewTalkingPointItem (+15 more)
...
Cohesion: 0.12
Nodes (25): delete_application(), delete_event(), get_staleness_stats(), AsyncSession, delete, get, post, # TODO: Trigger re-indexing of the embedding for this application based on the… (+17 more)
...
### Community 135 - "schemas/applications.py"
Cohesion: 0.14
Nodes (18): ApplicationQuestionsUpdateRequest, generate_application_form_answers(), update_application_questions(), ActionItemDetail, ApplicationDetailResponse, ApplicationEventDetail, ApplicationFilterParams, ApplicationListItem (+10 more)
...
Cohesion: 0.11
Nodes (32): AIHealthStatusRead, AIProviderCreate, AIProviderModelsResponse, AIProviderRead, AIProviderTestResponse, AIProviderUpdate, AITaskBindingCreate, AITaskBindingRead (+24 more)
...
### Community 150 - "resolve_company_about_url"
Cohesion: 0.25
...
Cohesion: 0.10
Nodes (38): AllowedApplicationStatus, ApplicationAnalyzeSpecRequest, ApplicationTransitionRequest, ApplicationUpdate, AsyncSession, analyze_app_job_spec(), bulk_transition_applications(), clear_app_interview_guide() (+30 more)

### Community 174 - "company_research.py"
Cohesion: 0.12
Nodes (21): build_company_research_queries(), build_ratings_query(), compute_avg_rating(), _extract_json(), _invoke_llm(), _missing_fields(), _normalise_profile_links(), _normalise_url() (+13 more)

### Community 177 - "set_ai_task_binding"
Cohesion: 0.31
...
### Community 223 - "test_resolve_staged_item_and_generate_embeddings"
Cohesion: 0.19
Nodes (11): BaseModel, model_validator, Schema for displaying an item in the staging queue., Paginated wrapper for staging list endpoint., Payload for user manual resolution/override of a staged email or job lead., StagingBulkDismissResponse, StagingItemRead, StagingItemResolve (+3 more)

### Community 224 - "intake_pasted_text"
Cohesion: 0.67
Nodes (3): intake_pasted_text(), Ingests raw pasted email text, thread, or job communication by queuing an AI…, PasteIntakeRequest

### Community 230 - "CompanyModel"
Cohesion: 0.14
Nodes (28): AgentChatModel, ApplicationEventModel, CompanyModel, archive_stale_applications(), delete_stale_agent_chats(), Any, AsyncSession, Finds all applications in active stages where last_activity_at (or… (+20 more)

### Community 232 - "main.py"
Cohesion: 0.07
Nodes (29): get_db(), AsyncSession, generate_query_embedding(), Generates a vector embedding for an incoming search query string using…, lifespan(), AsyncSession, get, Returns matching companies alongside total tracked application count. (+21 more)
