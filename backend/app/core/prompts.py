...
DEFAULT_PROMPTS = {
    "jd_extraction": (
        ...
        "- company: Extract strictly the clean canonical hiring employer name (e.g. 'Stripe', 'Linear', 'Datadog'). Strip corporate suffixes like 'Inc.', 'LLC', 'Ltd', and job portal wrappers like ' - Careers' or 'Job Opening at...'. Never return ATS platform names (Greenhouse, Lever, Ashby, Workday) or job boards (LinkedIn, Indeed).\n"
        "- company_url: Extract the company's official website root domain ONLY if explicitly stated or linked in the posting text (e.g. 'stripe.com', 'linear.app'). Strip protocols, www, and subpaths. If not explicitly mentioned in the text, MUST set to null. STRICTLY DO NOT guess, infer, or hallucinate domains.\n"
