...
DEFAULT_PROMPTS = {
    ...
    "email_extraction": (
        ...
        "- action: string | null (Concise description of the action and deadline if mentioned, e.g. 'Schedule phone screen via Calendly link', 'Complete HackerRank assessment by Friday 5 PM')\n"
