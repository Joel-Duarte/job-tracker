...
def test_calibrate_assessment_score_prevents_arbitrary_risk_cliff_drop():
    ...
    # 4. Low programmatic baseline with 0 risks respects AI-first holistic evaluation (not clamped to 60)
    low_match_score, low_rec = calibrate_assessment_score_and_recommendation(
        raw_fit_score=85,
    ...
    assert low_match_score == 85
    assert low_rec == "APPLY_STRONGLY"
