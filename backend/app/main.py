...
from app.routers import applications, events, search, admin, prompts, intake, email_accounts, staging, llm
...
app.include_router(llm.router, prefix="/api/v1")  # Ensure staging router is included
