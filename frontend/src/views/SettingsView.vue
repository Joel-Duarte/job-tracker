          ...
          <div class="theme-customizer-grid">
            ...
            <div class="customizer-subcard">
              <div class="subcard-header">
                ...
                <span class="subcard-token font-mono">--bg-app</span>
              </div>

              <!-- Swatch Dots Row -->
              <div class="swatches-dots-row">
                <template v-if="uiStore.theme === 'midnight'">
                  <button
                    type="button"
                    class="swatch-dot-btn"
                  ...
                  >
                    <span class="swatch-dot" style="background-color: #12161f;"></span>
                  </button>
                  <button
                    type="button"
                    class="swatch-dot-btn"
                  ...
                  >
                    <span class="swatch-dot" style="background-color: #0a1120;"></span>
                  </button>
                  <button
                    type="button"
                    class="swatch-dot-btn"
                  ...
                  >
                    <span class="swatch-dot" style="background-color: #0b0f19;"></span>
                  </button>
                </template>
                <template v-else>
                  <button
                  ...
                  >
                    <span class="swatch-dot" style="background-color: #e5ded1;"></span>
                  </button>
                  <button
                    type="button"
                    class="swatch-dot-btn"
                  ...
                  >
                    <span class="swatch-dot" style="background-color: #ede7dc;"></span>
                  </button>
                  <button
                    type="button"
                    class="swatch-dot-btn"
                  ...
                  >
                    <span class="swatch-dot" style="background-color: #faf8f5;"></span>
                  </button>
                  <button
                    type="button"
                    class="swatch-dot-btn"
                  ...
                  >
                    <span class="swatch-dot" style="background-color: #ffffff;"></span>
                  </button>
                </template>
              </div>

              <!-- Custom Picker Row -->
              <div class="custom-color-compact">
                <input
                  type="color"
                  class="color-input-dot"
                ...
                <input
                  type="text"
                  class="form-input font-mono input-xs"
                  placeholder="#HEX"
                  :value="uiStore.theme === 'midnight' ? (uiStore.customDarkBg || '#000000') : (uiStore.customLightBg || '#E5DED1')"
                ...
                <button
                  type="button"
                  class="btn btn-ghost btn-xs text-secondary icon-btn-compact"
            ...
            <div class="customizer-subcard">
              <div class="subcard-header">
                <span class="subcard-title">2. Card Surfaces</span>
                <span class="subcard-token font-mono">--bg-card</span>
              </div>
              ...
              <div class="swatches-dots-row">
                <template v-if="uiStore.theme === 'midnight'">
                  ...
                  >
                    <span class="swatch-dot" style="background-color: #11151e;"></span>
                  </button>
                  <button
                    type="button"
                    class="swatch-dot-btn"
                  ...
                  >
                    <span class="swatch-dot" style="background-color: #1a212e;"></span>
                  </button>
                  <button
                    type="button"
                    class="swatch-dot-btn"
                  ...
                  >
                    <span class="swatch-dot" style="background-color: #1e2738;"></span>
                  </button>
                  <button
                    type="button"
                    class="swatch-dot-btn"
                  ...
                  >
                    <span class="swatch-dot" style="background-color: #161922;"></span>
                  </button>
                </template>
                <template v-else>
                  <button
                  ...
                  >
                    <span class="swatch-dot" style="background-color: #f7f4ee;"></span>
                  </button>
                  <button
                    type="button"
                    class="swatch-dot-btn"
                  ...
                  >
                    <span class="swatch-dot" style="background-color: #fcfbf8;"></span>
                  </button>
                  <button
                    type="button"
                    class="swatch-dot-btn"
                  ...
                  >
                    <span class="swatch-dot" style="background-color: #f2ede4;"></span>
                  </button>
                </template>
              </div>
            ...
            <div class="customizer-subcard">
              <div class="subcard-header">
                <span class="subcard-title">3. Primary Accent</span>
                <span class="subcard-token font-mono">--primary</span>
              </div>
              ...
              <div class="swatches-dots-row">
                <template v-if="uiStore.theme === 'midnight'">
                  ...
                  >
                    <span class="swatch-dot" style="background-color: #2dd4bf;"></span>
                  </button>
                  <button
                    type="button"
                    class="swatch-dot-btn"
                  ...
                  >
                    <span class="swatch-dot" style="background-color: #38bdf8;"></span>
                  </button>
                  <button
                    type="button"
                    class="swatch-dot-btn"
                  ...
                  >
                    <span class="swatch-dot" style="background-color: #3b82f6;"></span>
                  </button>
                  <button
                    type="button"
                    class="swatch-dot-btn"
                  ...
                  >
                    <span class="swatch-dot" style="background-color: #fbbf24;"></span>
                  </button>
                </template>
                <template v-else>
                  <button
                  ...
                  >
                    <span class="swatch-dot" style="background-color: #854d0e;"></span>
                  </button>
                  <button
                    type="button"
                    class="swatch-dot-btn"
                  ...
                  >
                    <span class="swatch-dot" style="background-color: #b45309;"></span>
                  </button>
                  <button
                    type="button"
                    class="swatch-dot-btn"
                  ...
                  >
                    <span class="swatch-dot" style="background-color: #c2410c;"></span>
                  </button>
                  <button
                    type="button"
                    class="swatch-dot-btn"
                  ...
                  >
                    <span class="swatch-dot" style="background-color: #ca8a04;"></span>
                  </button>
                </template>
              </div>
            ...
            <div class="customizer-subcard">
              <div class="subcard-header">
                <span class="subcard-title">4. Borders</span>
                <span class="subcard-token font-mono">--border-color</span>
              </div>
              ...
              <div class="swatches-dots-row">
                <template v-if="uiStore.theme === 'midnight'">
                  ...
                  >
                    <span class="swatch-dot" style="background-color: #1c2534;"></span>
                  </button>
                  <button
                    type="button"
                    class="swatch-dot-btn"
                  ...
                  >
                    <span class="swatch-dot" style="background-color: #263245;"></span>
                  </button>
                  <button
                    type="button"
                    class="swatch-dot-btn"
                  ...
                  >
                    <span class="swatch-dot" style="background-color: #303e55;"></span>
                  </button>
                  <button
                    type="button"
                    class="swatch-dot-btn"
                  ...
                  >
                    <span class="swatch-dot" style="background-color: #334155;"></span>
                  </button>
                </template>
                <template v-else>
                  <button
                  ...
                  >
                    <span class="swatch-dot" style="background-color: #b8aa97;"></span>
                  </button>
                  <button
                    type="button"
                    class="swatch-dot-btn"
                  ...
                  >
                    <span class="swatch-dot" style="background-color: #d8cfc2;"></span>
                  </button>
                  <button
                    type="button"
                    class="swatch-dot-btn"
                  ...
                  >
                    <span class="swatch-dot" style="background-color: #c7bcaa;"></span>
                  </button>
                  <button
                    type="button"
                    class="swatch-dot-btn"
                  ...
                  >
                    <span class="swatch-dot" style="background-color: #e4ddd2;"></span>
                  </button>
                </template>
              </div>
...
.swatch-dot-btn:hover {
  transform: scale(1.12);
  border-color: var(--border-focus);
}

.swatch-dot-btn.active {
  border-color: var(--primary);
  box-shadow: 0 0 0 2px var(--primary-subtle);
}
...
.color-input-dot::-webkit-color-swatch-wrapper {
  padding: 0;
}

.color-input-dot::-webkit-color-swatch {
  border: none;
  border-radius: var(--radius-xs);
}
